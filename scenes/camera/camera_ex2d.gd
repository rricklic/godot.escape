...
func _ready() -> void:
	# GlobalSignals.signal_shake.connect(_shake) #TODO: signal to shake
...
func _physics_process(delta: float) -> void:
	...
	#_handle_debug_movement(delta) # TODO:
...
func _handle_target_movement(delta: float) -> void:
	...
	var screen_size: Vector2 = get_viewport_rect().size # get_viewport_size
